...
export const SidebarSocialMedia = ({ className }: Props) => {
  return (
    <div
      className={`text-center flex flex-row mx-auto my-10 items-center  ${className}`}
    >
  ...
  return (
    <div className={`w-[832px] h-[980px] border-r-3 border-white"`}>
      {cameraOn && cameraOn ? (
        <div
          id="CameraBox"
          className="w-full h-[337.5px] border-b-3 border-white"
        />
      ) : (
        <div className="h-[337.5px] border-b-3 border-white">
          <NoCamera />
        </div>
      )}
      <div
